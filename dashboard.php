    ...
    <div class="searchBox">
      ...
      <div class="searchHolder menuItems">
        <form method='post'>
          ...
          <button class="w3-btn btn-primary w3-ripple buttonBoi" type="submit"><i class="fa fa-search  w3-red"></i></button>
        </form>
      </div>
      <div class="menuItems">
        <form method='post'>
          <input class="w3-btn btn-primary w3-tiny w3-ripple buttonBoi" type="submit" value="Reset" name="reset" />
        </form>
      </div>
    </div>
    <div class="menuItems">
